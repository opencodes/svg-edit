...
export class EditorComponent implements OnInit {
  ...
  public loadScript() {
    ...
    // _window.document.onload = (function (d3, saveAs, Blob, undefined) {
    ...
    //       } else {
    //         alert('Your browser wont let you save this graph -- try upgrading your browser to IE 10+ or Chrome or Firefox.');
    //       }
    ...
    //     svg.attr('width', x - 100).attr('height', y);
    //   };
